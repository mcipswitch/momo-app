...
class MockDataManager {
    ...
    init() {
        entries = [
            ...
            Entry(id: UUID(), emotion: "Ocean", date: date.createDate(year: 2020, month: 11, day: 09), value: 0.0),
            Entry(id: UUID(), emotion: "Fire", date: date.createDate(year: 2020, month: 11, day: 10), value: 0.2),
            Entry(id: UUID(), emotion: "Artsy", date: date.createDate(year: 2020, month: 11, day: 11), value: 0.4),
            Entry(id: UUID(), emotion: "Gloomy", date: date.createDate(year: 2020, month: 11, day: 12), value: 0.6),
            Entry(id: UUID(), emotion: "Candy", date: date.createDate(year: 2020, month: 11, day: 13), value: 0.8),
            Entry(id: UUID(), emotion: "Lights", date: date.createDate(year: 2020, month: 11, day: 14), value: 0.9),
